          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_term'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open('terms/create', $attributes);
					?>
					...
					?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						 <?php								foreach($langs as $lang)								{									$ourtypes[$lang->code] = $lang->title;								}																			echo form_dropdown('lang', $ourtypes, array(), 'id="lang" class="form-control" required="required"');						?>
                        </div>
					  ...
					  <div class="form-group">
						...
						?>
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						<?php							$data = array(								'name' => 'desc',								'id' => 'desc',								'placeholder' => lang('desc'),								'class' => 'form-control col-md-7 col-xs-12',								'value' => htmlspecialchars_decode(set_value('desc'))							);							echo form_textarea($data);													?>
                        </div>
                      </div>
					  <div class="form-group">
                        <?php
