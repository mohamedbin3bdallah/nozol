          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_place'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('places/create', $attributes);
					?>
					  ...
					  <div class="form-group">
						...
						<?php							$ourtypes = array(lang('country'));							
							if(!empty($places))
							{
								...
								{
									$ourtypes[$place->id] = $place->title;
								}											
							}																					echo form_dropdown('parent', $ourtypes, array(), 'id="country" class="form-control" required="required"');
						?>
                        </div>
                      </div>					  					  <div id="governorates" class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('governorate'),'governorate',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						<?php							$ourtypes1 = array(lang('governorate'));																					echo form_dropdown('parent1', $ourtypes1, array(), 'id="governorate" class="form-control" required="required"');						?>                        </div>                      </div>					  					  <!--<div id="districts" class="form-group">						<?php							/*$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('district'),'district',$data);*/						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php //echo $input_class; ?>">						<?php							/*$ourtypes2 = array(lang('district'));																					echo form_dropdown('parent2', $ourtypes2, array(), 'id="district" class="form-control" required="required"');*/						?>                        </div>                      </div>-->
                      <div class="form-group">
                        <?php
							$data = array(
								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,
