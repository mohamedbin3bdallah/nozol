                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('pages/editpage/'.$page->id, $attributes);
					?>
					...
					?>															<?php if(isset($langs) && !empty($langs)) { ?>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php								foreach($langs as $lang)								{									$ourtypes[$lang->code] = $lang->title;								}																			echo form_dropdown('lang', $ourtypes, array('lang'=>$page->code), 'id="lang" class="form-control" required="required"');						?>
                        </div>
					 ...
					 <div class="form-group">                        <?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('desc').' <span class="required">*</span>','desc',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						<?php							$data = array(								'name' => 'desc',								'id' => 'desc',								'placeholder' => lang('desc'),								'class' => 'form-control col-md-7 col-xs-12',								'value' => htmlspecialchars_decode($page->desc)							);							echo form_textarea($data);													?>                        </div>                      </div>					  					  					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(' ','',$data);						?>                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							if(isset($page->img) && $page->img != '' && file_exists($this->config->item('pages_folder').$page->img))							{ 								?><img src="<?php echo base_url().$this->config->item('pages_folder').$page->img; ?>" class="img-responsive" style="max-width:150px;max-height:150px;"/><?php								$data = array(									'oldimg'  => $page->img								);								echo form_hidden($data);							}						?>                        </div>                      </div>					  <div class="form-group">						<?php							$data = array(								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,							);							echo form_label(lang('image'),'image',$data);						?>                        <div id="doc_mdl3" class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">						  <?php							$data = array(								'type' => 'file',								'name' => 'img',								'id' => 'img',								'class' => 'form-control col-md-7 col-xs-12',							);							echo form_upload($data);						?>												</div>                      </div>
					  <div class="form-group">
                        <?php
							$data = array(
								'class' => 'control-label col-md-3 col-sm-3 col-xs-12'.$label_class,
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php
							...
							if($page->active == '1') $data['checked'] = 'TRUE';
